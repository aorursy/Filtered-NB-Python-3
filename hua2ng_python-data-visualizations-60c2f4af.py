...
sns.FacetGrid(iris, hue="Species", size=5)    .map(plt.scatter, "SepalLengthCm", "PetalLengthCm")    .add_legend()

sns.FacetGrid(iris, hue="Species", size=5)    .map(plt.scatter, "SepalWidthCm", "PetalWidthCm")    .add_legend()
