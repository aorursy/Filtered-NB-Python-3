...
tweets = sent_tokenize(clean_tweets(tweet_data[trends[0]]['tweets'][:1000])+            clean_tweets(tweet_data[trends[1]]['tweets'][:1000])+            clean_tweets(tweet_data[trends[2]]['tweets'][:1000]))
