...
dblock = DataBlock(blocks=(ImageBlock, MultiCategoryBlock),
                   splitter=RandomSplitter(valid_pct=0.2, random_state=42), 
...
learn.fine_tune(3, base_lr=1e-4, freeze_epochs=4)
...
learn.fine_tune(50, base_lr=1e-4, freeze_epochs=4)
...
sub_fname = 'submission_erjan2.csv
...
sub_fname = 'submission_erjan.csv'
