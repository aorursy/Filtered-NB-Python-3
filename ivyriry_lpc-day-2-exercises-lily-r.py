...
def to_smash(total_candies, friends_number= 3):
    ...
    the given number of candies evenly between friends_number.
    
    If not friend_number is given the default will be 3
...
def smallest_stringy_number(s1, s2, s3):
    ...
    """
    return min(s1, s2, s3)
smallest_stringy_number(sleep(2), '2', '3')
