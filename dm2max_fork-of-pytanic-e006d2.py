...
train['Large_Family'] = (train['SibSp']>2) | (train['Parch']>3)
...
train['Young'] = (train['Age']<=30) | (train['Title'].isin(['Master','Miss','Mlle']))
...
test['Large_Family'] = (test['SibSp']>2) | (test['Parch']>3)
...
test['Young'] = (test['Age']<=30) | (test['Title'].isin(['Master','Miss','Mlle']))
